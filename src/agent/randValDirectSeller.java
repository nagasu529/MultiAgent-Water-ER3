...
public class randValDirectSeller extends Agent {
    randValDirectSellerGui myGui;
    ...
    protected void setup(){
        ...
        myGui = new randValDirectSellerGui(this);
        myGui.show();
        ...
        public void action() {
            switch (step) {
                case 0:
                    ...
                    cfp.setContent(sellerInfo.sellingVol.toString() + "-" + sellerInfo.sellingPrice + "-" + getAID().getLocalName());
                    ...
                    if (reply != null) {
                        ...
                        if (reply.getPerformative() == ACLMessage.PROPOSE) {
                            ...
                            if(tempPrice > sellerInfo.sellingPrice && tempVolume == sellerInfo.sellingVol){
                                bidderReplyList.add(new Agents(reply.getSender().getLocalName(), tempDBName, tempVolume, tempPrice));
                            }
                        }
                ...
                case 2:
                    ...
                    //Sending PROPOSE message to Bidder (only the best option for volume requirement.
    ...
    class Agents{
        ...
        public String toString(){
            ...
            return this.name + "   " + "Total Volume: " + this.totalVolume + "  Price: " + this.price + " DB Name: " + this.dbName;
        }
    }
